...
public class OfflineMemberAdapter extends BaseAdapter {
    ...
    public OfflineMemberAdapter(Context context,ArrayList<MemberPOJO> list,String defaultIcon){
        mContext = context;
