...
public class SerialPortManagerA5 {

	private static SerialPortManagerA5 mSerialPortManagerA5 = new SerialPortManagerA5();
	...
	private AsyncFingerprintA5 asyncFP=null;

	private CommonApi mCommonApi;

	public AsyncFingerprintA5 getNewAsyncFingerprint() {
		if (!isOpen) {
			try {
				openSerialPort();
				isOpen = true;
			...
			Cancel(false);
			asyncFP= new AsyncFingerprintA5(looper);
			asyncFP.Cancel(false);
			Log.i("xpb", "Open Serial");
			return asyncFP;
		}
		return asyncFP;
		//return new AsyncFingerprintA5(looper);
	}

	public SerialPortManagerA5() {
	}


	public static SerialPortManagerA5 getInstance() {
		return mSerialPortManagerA5;
	}
